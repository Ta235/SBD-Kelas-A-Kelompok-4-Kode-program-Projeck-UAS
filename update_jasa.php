...
<div class="jasa">
        ...
        <form id="jasaForm">
            ...
            <button type="button" onclick="callPhpFunction()">Update Data Jasa</button>
        </form>
    </div>
</body>
<script>
    function callPhpFunction() {
        ...
        console.log({
            kd_jasa, nama_jasa, harga, satuan
        })
        ...
        xhttp.open("POST", "update_jasa_function.php", true);
