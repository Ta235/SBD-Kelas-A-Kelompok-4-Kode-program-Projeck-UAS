...
<body>
    <div class="nav_container">
        <nav>
            ...
            <div class="nav-item" onclick="window.location.href='viewPelanggan.php';">
    ...
    <div class="content">
        <div class="headingContainer">
            ...
            <?php include 'view_jasa.php'?>
            </div>
            <div class="menuData">
                <div class="itemMenu" onclick="window.location.href='insert_jasa.php';">Tambah Data</div>
                <div class="itemMenu" onclick="window.location.href='update_jasa.php';">Edit Data</div>
                <div class="itemMenu" onclick="window.location.href='delete_jasa.php';">Hapus Data</div>
            </div>
        </div>
    </div>
    <div class="footer">
