...
<body>
    ...
    <div class="content">
        <div class="headingContainer">
            ...
            <?php include 'view_pelanggan.php'?>
            </div>
            <div class="menuData">
                <div class="itemMenu" onclick="window.location.href='insert_pelanggan.php';">Tambah Data</div>
                <div class="itemMenu" onclick="window.location.href='update_pelanggan.php';">Edit Data</div>
                <div class="itemMenu" onclick="window.location.href='delete_pelanggan.php';">Hapus Data</div>
            </div>
        </div>
    </div>
    <div class="footer">
